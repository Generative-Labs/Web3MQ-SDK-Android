...
public class FollowingFragment extends BaseFragment {
    ...
    public static synchronized FollowingFragment getInstance() {
        if (instance == null) {
            instance = new FollowingFragment();
        }
        return instance;
    }
    ...
    private void requestData() {
        Web3MQFollower.getInstance().getMyFollowing(1, 20, new GetMyFollowingCallback() {
            @Override
